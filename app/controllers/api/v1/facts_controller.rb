class Api::V1::FactsController < ApplicationController
    ...
    def show
      ...
      if set_fact
        ...
        render json: { error:
        "The fact could not be found: #{@fact.error.full_messages.to_sentence}"},
        status: 400
      end
    end
    ...
    def update
      ...
      if @fact.update(fact_params)
        ...
        render json: { error:
        "The fact: #{@fact}, could not be updated: #{@fact.errors.full_messages.to_sentence}"},
        status: 400
      end
    end
    ...
    def destroy
      ...
      @fact = Fact.find(params[:id])
      @fact.destroy
      render json: "This fact has been destroyed.", status: 200
    end
